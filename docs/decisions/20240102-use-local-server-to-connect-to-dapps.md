...
**Confidence**: (2026-01-14) High. Firewalls often make exceptions for localhost. It seems a variety of other apps use similar methods for creating connections with other apps.
