...
// XXX: Modified from https://github.com/algorand/go-algorand/tree/c2d7047585f6109d866ebaf9fca0ee7490b16c6a/daemon/kmd/wallet/driver/sqlite_crypto.go
...
func extractKeyWithIndex(derivationKey []byte, index uint64) (pk ed25519.PublicKey, sk ed25519.PrivateKey, err error) {
	...
	// Convert seed into secret key
	sk = ed25519.NewKeyFromSeed(seed[:])
	// Get the secret key's corresponding public key
