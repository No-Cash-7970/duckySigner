...
// Wallet connection session information, which is eventually stored by the
// wallet connection server
// TODO: Rename to `DappConnectSession`
type WalletConnectionSession struct {
	...
	// TODO: Rename to DappConnectSharedKey
	WalletConnectionKey *memguard.Enclave
}
