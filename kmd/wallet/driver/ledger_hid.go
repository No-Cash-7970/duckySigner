...
// XXX: From https://github.com/algorand/go-algorand/tree/c2d7047585f6109d866ebaf9fca0ee7490b16c6a/daemon/kmd/wallet/driver/ledger_hid.go
...
func LedgerEnumerate() ([]hid.DeviceInfo, error) {
	...
	//  we search for the Ledger Vendor id and ignore devices that don't have specific usage page or interface
	hids := hid.Enumerate(ledgerVendorID, 0)
